...
public class DeviceInfoSettings extends SettingsPreferenceFragment {
    ...
    private static final String KEY_CK_UPDATES = "ck_updates";
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (UserHandle.myUserId() == UserHandle.USER_OWNER) {
            removePreferenceIfPackageNotInstalled(findPreference(KEY_CK_UPDATES));
        } else {
            getPreferenceScreen().removePreference(findPreference(KEY_CK_UPDATES));
        }
