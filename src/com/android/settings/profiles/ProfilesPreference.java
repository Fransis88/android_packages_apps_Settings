...
public class ProfilesPreference extends CheckBoxPreference {
    ...
    private View mProfilesPowerMenu;
    ...
    protected void onBindView(View view) {
        ...
        mProfilesPowerMenu = view.findViewById(R.id.profiles_pref);
        mProfilesPowerMenu.setOnClickListener(mPrefOnclickListener);
    ...
    private void disablePreferenceViews() {
        ...
        if (mProfilesPowerMenu != null) {
            mProfilesPowerMenu.setEnabled(false);
            mProfilesPowerMenu.setBackgroundColor(0);
        }
    }
    ...
    private void updatePreferenceViews() {
        ...
        if (mProfilesPowerMenu != null) {
            mProfilesPowerMenu.setEnabled(true);
            mProfilesPowerMenu.setLongClickable(checked);
            final boolean enabled = isEnabled();
            mProfilesPowerMenu.setOnClickListener(enabled ? mPrefOnclickListener : null);
            if (!enabled) {
                mProfilesPowerMenu.setBackgroundColor(0);
            }
        }
